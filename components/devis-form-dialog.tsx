...
export function DevisFormDialog({ children }: DevisFormDialogProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setOpen(false)
    setFormData({ client: "", date: "", montant: "", statut: "", validite: "" })
  }
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Remplissez les informations du nouveau devis ici. Cliquez sur enregistrer lorsque vous avez terminé.
          </DialogDescription>
        </DialogHeader>
