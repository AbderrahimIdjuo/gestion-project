...
export function CommandeFormDialog({ children }: CommandeFormDialogProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setOpen(false)
    setFormData({ client: "", date: "", montant: "", statut: "" })
  }
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Remplissez les informations de la nouvelle commande ici. Cliquez sur enregistrer lorsque vous avez terminé.
          </DialogDescription>
        </DialogHeader>
