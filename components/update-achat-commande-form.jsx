...
export function UpdateAchatCommandeForm({ currCommande }) {
  ...
  const {
    ...
    defaultValues: {
      prixUnite: currCommande?.produit.prixAchat,
      produit: currCommande?.produit,
      description: currCommande?.produit.description,
      payer: currCommande?.payer,
      fournisseur: currCommande?.produit.fournisseur,
      quantite : currCommande?.quantite,
    },
  });
